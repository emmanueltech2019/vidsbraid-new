        ...
        <div className="md:flex flex-row-reverse items-center">
          ...
          <header data-aos="fade" className="px-4 md:mx-[2rem] md:w-[40%]">
            ...
            <div className="button my-2 flex">
              <button className="px-8 py-3 text-[#FEFCFD] text-[14px] md:text-[20px] bg-[#800020] rounded-lg h-[50px] flex items-center gap-2" onClick={()=>setShowModal(true)}>
                ...
                <div className='lg:max-[95%] p-4'>
                    ...
                    <div className="footer-info my-5">
                        ...
                        <div className="button text-center my-7 flex justify-center ">
                            <button className="px-8 py-3 text-[#FEFCFD] bg-[#800020] rounded-lg h-[50px] flex items-center gap-2" onClick={()=>setShowModal(true)}>
