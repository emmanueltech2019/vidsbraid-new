...
function Navbar() {
    ...
    return (
        <div className="overflow-hidden">
            <section className={navbarBg ? ' p-2 fixed w-full z-[999] bg-[#f9f1f301] transition-all duration-500 ease-in-out' : 'p-4 fixed w-full z-[999] bg-[#f9f1f3] transition-all duration-500 ease-in-out'}>
                <div className='lg:max-w-[95%] m-auto md:flex justify-between items-center'>
                    <header className='flex justify-between items-center'>
                        <div className="logo">
                           
                            <Image src={logoImg} className='md:w-[70px] md:h-[70px]' alt="alt" width={50} height={50} />
                        </div>
